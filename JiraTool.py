...
if __name__ == '__main__':
    ...
    for project in projects:
        ...
        print('the projects is ', project[0])
        print('the boolean is ', os.path.exists(statistics_path + project[0] + '.csv'))
        if os.path.exists(statistics_path + project[0] + '.csv'):
            continue
        # if project[0] != 'FOR':
        #     continue
        jiratool.collect_bug_report(project[0], root_path)
